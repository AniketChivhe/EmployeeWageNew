...
namespace UC10_ManageWageOFCompanies
{
    class Program
    {
        ...
        public class EmpBuilderWage
        {
            ...
            {
                Console.WriteLine("Welcome to employee wage computation - UC10_UC10_ManageWageOFCompanies");
                EmpBuilderWage empBuilderWage = new EmpBuilderWage();
                empBuilderWage.addCompanyEmpWage("TESLA", 20, 15, 10);
                empBuilderWage.addCompanyEmpWage("BMW", 10, 20, 20);
